...
const APPOINTMENT_REVIEW_TRACKS = new Set(['home', 'auto', 'bundle', 'buyer', 'renter', 'life', 'business', 'general']);
...
const APPOINTMENT_ENTRY_ROUTES = Object.freeze({
  home:['/home'], auto:['/auto'], home_auto:['/auto-bundle'], buyer:['/buyer'], life:['/life'], business:['/business'],
