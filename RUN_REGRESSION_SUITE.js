...
const testFiles = [
  ...
  path.join(__dirname, 'tests', 'tech-pvx-progressive-snapshot-1.0.test.mjs'),
  path.join(__dirname, 'tests', 'tech-appointment-flow-1.0.test.mjs'),
  path.join(__dirname, 'tests', 'appointment-first-all-flows-1.0.test.mjs'),
  path.join(__dirname, 'tests', 'snapshot-entry-progression-1.0.test.mjs'),
  path.join(__dirname, 'tests', 'lead-operations-1.0.test.mjs'),
  path.join(__dirname, 'tests', 'lead-operations-1.1.test.mjs'),
  path.join(__dirname, 'tests', 'early-lead-workspace-1.0.test.mjs'),
  path.join(__dirname, 'tests', 'sms-entry-routing-1.1.test.mjs'),
  path.join(__dirname, 'tests', 'sms-contact-choices-1.0.test.mjs'),
  path.join(__dirname, 'tests', 'producer-call-now-alert-1.0.test.mjs'),
